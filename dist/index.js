...
exports.DEFAULT_BASE_API_URL = void 0;
const game_1 = require("@virtuals-protocol/game");
const utils_1 = require("./utils");
// Default configuration values
exports.DEFAULT_BASE_API_URL = "https://api.tokenmetrics.com/v2";
class TokenMetricsPlugin {
    constructor(options) {
        ...
        this.baseApiUrl =
            options.apiClientConfig.baseApiUrl || exports.DEFAULT_BASE_API_URL;
    }
    getWorker(data) {
    ...
    get getTokens() {
        return new game_1.GameFunction({
            name: "get_tokens",
            description: "Get the complete list of cryptocurrencies and their TOKEN_ID supported by TokenMetrics. To get ALL available tokens, use only 'limit' and 'page' parameters. Use search parameters (token_name, symbol, category) only when specifically searching for particular cryptocurrencies.",
            args: [
                {
                    name: "limit",
            ...
            executable: async (args, logger) => {
                try {
                    ...
                    return await (0, utils_1.tokenMetricsApiCall)(this.apiKey, this.baseApiUrl, "/tokens", args, logger);
                }
                catch (e) {
    ...
    get getTopMarketCapTokens() {
        return new game_1.GameFunction({
            ...
            description: "Get the list of coins for top market cap. Useful for finding the most valuable cryptocurrencies by market capitalization.",
            args: [
                {
                    name: "top_k",
            ...
            executable: async (args, logger) => {
                try {
                    ...
                    return await (0, utils_1.tokenMetricsApiCall)(this.apiKey, this.baseApiUrl, "/top-market-cap-tokens", args, logger);
                }
                catch (e) {
                    return (0, utils_1.exceptionHandler)(e, logger);
                }
    ...
    get getPriceData() {
        return new game_1.GameFunction({
            name: "get_price_data",
            description: "Get token prices based on the provided token IDs. Returns current market prices for specified cryptocurrencies.",
            args: [
                {
                    name: "token_id",
            ...
            executable: async (args, logger) => {
                try {
                    if (!args.token_id) {
                        return new game_1.ExecutableGameFunctionResponse(game_1.ExecutableGameFunctionStatus.Failed, "token_id is required for querying price data");
                    }
                    logger(`Querying price data for token IDs: ${args.token_id}`);
                    return await (0, utils_1.tokenMetricsApiCall)(this.apiKey, this.baseApiUrl, "/price", args, logger);
                }
                catch (e) {
                    return (0, utils_1.exceptionHandler)(e, logger);
                }
    ...
    get getTraderGrades() {
        return new game_1.GameFunction({
            ...
            description: "Get the short term AI grades including 24h percent change for TM Trader Grade. These grades help identify short-term trading opportunities.",
            args: [
                {
                    name: "token_id",
            ...
            executable: async (args, logger) => {
                try {
                    ...
                    return await (0, utils_1.tokenMetricsApiCall)(this.apiKey, this.baseApiUrl, "/trader-grades", args, logger);
                }
                catch (e) {
                    return (0, utils_1.exceptionHandler)(e, logger);
                }
    ...
    get getInvestorGrades() {
        return new game_1.GameFunction({
            ...
            description: "Get the long term grades including Technology and Fundamental metrics. These provide comprehensive long-term investment analysis.",
            args: [
                {
                    name: "token_id",
                    description: "Comma separated Token IDs",
            ...
            executable: async (args, logger) => {
                try {
                    ...
                    return await (0, utils_1.tokenMetricsApiCall)(this.apiKey, this.baseApiUrl, "/investor-grades", args, logger);
                }
                catch (e) {
                    return (0, utils_1.exceptionHandler)(e, logger);
                }
    ...
    get getMarketMetrics() {
        return new game_1.GameFunction({
            ...
            description: "Get the Market Analytics from Token Metrics including Bullish/Bearish Market indicator. Provides overall crypto market sentiment and conditions.",
            args: [
                {
                    name: "startDate",
                    description: "Start date in YYYY-MM-DD format",
            ...
            executable: async (args, logger) => {
                try {
                    ...
                    return await (0, utils_1.tokenMetricsApiCall)(this.apiKey, this.baseApiUrl, "/market-metrics", args, logger);
                }
                catch (e) {
                    return (0, utils_1.exceptionHandler)(e, logger);
                }
    ...
    get getQuantmetrics() {
        return new game_1.GameFunction({
            ...
            description: "Get the latest quantitative metrics for tokens. Provides advanced mathematical analysis and statistical data for cryptocurrencies.",
            args: [
                {
                    name: "token_id",
                    description: "Comma separated Token IDs",
            ...
            executable: async (args, logger) => {
                try {
                    ...
                    return await (0, utils_1.tokenMetricsApiCall)(this.apiKey, this.baseApiUrl, "/quantmetrics", args, logger);
                }
                catch (e) {
                    return (0, utils_1.exceptionHandler)(e, logger);
                }
    ...
    get getHourlyOhlcv() {
        return new game_1.GameFunction({
            ...
            description: "Get hourly OHLCV (Open, High, Low, Close, Volume) data for tokens. Essential for technical analysis and charting.",
            args: [
                {
                    name: "token_id",
                    description: "Comma separated Token IDs",
            ...
            executable: async (args, logger) => {
                try {
                    ...
                    return await (0, utils_1.tokenMetricsApiCall)(this.apiKey, this.baseApiUrl, "/hourly-ohlcv", args, logger);
                }
                catch (e) {
                    return (0, utils_1.exceptionHandler)(e, logger);
                }
    ...
    get getDailyOhlcv() {
        return new game_1.GameFunction({
            ...
            description: "Get daily OHLCV (Open, High, Low, Close, Volume) data for tokens. Perfect for longer-term technical analysis and trend identification.",
            args: [
                {
                    name: "token_id",
                    description: "Comma separated Token IDs",
            ...
            executable: async (args, logger) => {
                try {
                    ...
                    return await (0, utils_1.tokenMetricsApiCall)(this.apiKey, this.baseApiUrl, "/daily-ohlcv", args, logger);
                }
                catch (e) {
                    return (0, utils_1.exceptionHandler)(e, logger);
                }
        ...
        return new game_1.GameFunction({
            ...
            executable: async (args, logger) => {
                try {
                    ...
                    return await (0, utils_1.tokenMetricsApiCall)(this.apiKey, this.baseApiUrl, "/ai-reports", args, logger);
                }
                catch (e) {
                    return (0, utils_1.exceptionHandler)(e, logger);
                }
    ...
    get getCryptoInvestors() {
        return new game_1.GameFunction({
            ...
            description: "Get the latest list of crypto investors and their scores. Provides insights into institutional and whale investor behavior.",
            args: [
                {
                    name: "limit",
                    description: "Limit the number of items in response (default: 50)",
            ...
            executable: async (args, logger) => {
                try {
                    ...
                    return await (0, utils_1.tokenMetricsApiCall)(this.apiKey, this.baseApiUrl, "/crypto-investors", args, logger);
                }
                catch (e) {
                    return (0, utils_1.exceptionHandler)(e, logger);
                }
    ...
    get getResistanceSupport() {
        return new game_1.GameFunction({
            ...
            description: "Get the historical levels of resistance and support for each token. Critical for technical analysis and identifying key price levels.",
            args: [
                {
                    name: "token_id",
                    description: "Comma separated Token IDs",
            ...
            executable: async (args, logger) => {
                try {
                    ...
                    return await (0, utils_1.tokenMetricsApiCall)(this.apiKey, this.baseApiUrl, "/resistance-support", args, logger);
                }
                catch (e) {
                    return (0, utils_1.exceptionHandler)(e, logger);
                }
    ...
    get getTokenMetricsAi() {
        return new game_1.GameFunction({
            ...
            description: "Chat with TokenMetrics AI to get insights about cryptocurrency markets, trading strategies, and investment advice. Ask any crypto-related question.",
            args: [
                {
                    name: "user_message",
            ...
            executable: async (args, logger) => {
                try {
                    if (!args.user_message) {
                        return new game_1.ExecutableGameFunctionResponse(game_1.ExecutableGameFunctionStatus.Failed, "user_message is required for TokenMetrics AI chat");
                    }
                    ...
                    return await (0, utils_1.tokenMetricsApiPostCall)(this.apiKey, this.baseApiUrl, "/tmai", requestBody, logger);
                }
                catch (e) {
                    return (0, utils_1.exceptionHandler)(e, logger);
                }
    ...
    get getSentiments() {
        return new game_1.GameFunction({
            name: "get_sentiments",
            description: "Get the hourly sentiment score for Twitter, Reddit, and all the News, including quick summary of what happened. Useful for understanding market sentiment and social media trends.",
            args: [
                {
                    name: "limit",
                    description: "Limit the number of items in response (default: 50)",
            ...
            executable: async (args, logger) => {
                try {
                    ...
                    return await (0, utils_1.tokenMetricsApiCall)(this.apiKey, this.baseApiUrl, "/sentiments", args, logger);
                }
                catch (e) {
                    return (0, utils_1.exceptionHandler)(e, logger);
                }
    ...
    get getScenarioAnalysis() {
        return new game_1.GameFunction({
            ...
            description: "Get the price prediction based on different Crypto Market scenarios. Provides forecasts under various market conditions (bullish, bearish, neutral).",
            args: [
                {
                    name: "token_id",
            ...
            executable: async (args, logger) => {
                try {
                    ...
                    return await (0, utils_1.tokenMetricsApiCall)(this.apiKey, this.baseApiUrl, "/scenario-analysis", args, logger);
                }
                catch (e) {
                    return (0, utils_1.exceptionHandler)(e, logger);
                }
    ...
    get getCorrelation() {
        return new game_1.GameFunction({
            ...
            description: "Get the Top 10 and Bottom 10 correlation of tokens with the top 100 market cap tokens. Useful for portfolio diversification and understanding token relationships.",
            args: [
                {
                    name: "token_id",
                    description: "Comma separated Token IDs. Click here to access the list of token IDs. Example: 3375,3306",
...
exports.default = TokenMetricsPlugin;
